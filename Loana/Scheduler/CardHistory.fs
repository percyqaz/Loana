...
type CardSpacingRule =
    ...
    member private this.NextLearning(history: CardHistory, ease: CardResult, now: int64, step: int): CardHistory =
    ...
    member this.Next(history: CardHistory, ease: CardResult, now: int64) : CardHistory =
