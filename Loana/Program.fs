...
while waiting_acceptance do
    ...
    let mysterious_flame =
        ...
        let r = Random() in let bg = Color.FromArgb(0x101010) in let struct (x, y) = System.Console.GetCursorPosition()
        fun () ->
            ...
            MenuRender.WriteLine(MenuRender.Pad "[C] Categorise [R] Reload  [Enter] Launch", Color.LightGray, Color.FromArgb(0x202020))
